...
# 150 fold cv
classifications = knn.cv(iris[,1:4],iris$Species, k = 10)
...
# k = 50
classifications = knn(train[,c(1,2)],test[,c(1,2)],train$Species, prob = TRUE, k = 50)
table(test$Species,classifications)
CM = confusionMatrix(table(test$Species,classifications))
CM$overall[1]
```
...
credit = read.csv('/Users/stevengarrity/SMU_MSDS/DS6306_DoingDataScience/DDS_Git/Unit 6/Credit Default.csv',header = TRUE)
