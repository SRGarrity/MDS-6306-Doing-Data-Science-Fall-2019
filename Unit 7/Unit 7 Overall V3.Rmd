...
#Volleyball Example
```{r}
vball = read.csv('/Users/stevengarrity/SMU_MSDS/DS6306_DoingDataScience/DDS_Git/Unit 7/Bayes Volleyball.csv',header = TRUE)
vball
...
Pnews_word("jogger", allNYTSearchTrain)
