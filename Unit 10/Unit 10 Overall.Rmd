...
hist(sampInterceptHolder, main = str_c("Distribution of Intercepts from ", numSampIntercepts, " Samples"), xlab = "Sample Intercpet")
...
preds = predict(fit)
mtcars %>% ggplot(aes(x = wt, y = mpg)) + geom_point() +
  geom_line(data = mtcars, aes( x = wt, y = preds, col = "red"))
```
