...
mpg %>% ggplot(aes(x = hwy, y = cty)) + geom_point() + ggtitle("City MPG v. Highway MPG") + geom_smooth()
```
...
mpg %>% ggplot(aes(x = displ, y = hwy, linetype = drv)) + geom_point() + geom_smooth()
...
mpg %>% ggplot(aes(x = hwy, y = cty, linetype=drv, color=drv)) + geom_point() + geom_smooth()
# mpg %>% ggplot(aes(x = hwy, y = cty, color=drv)) + geom_point(shape=mpg$drv) + geom_smooth()
...
ggplot(data = mpg) + geom_point(mapping = aes(x = hwy, y = cty, color = class)) + geom_smooth(mapping = aes(x = hwy, y = cty, linetype = drv, color = drv))

#Individual aes() …. an aesthetic for each layer
ggplot(data = mpg) + geom_point(mapping = aes(x = hwy, y = cty, color = class)) + geom_smooth(mapping = aes(x = hwy, y = cty, linetype = class, color = class)) + facet_wrap(~class)
...
mpg %>% ggplot(aes(x = class, y = cty)) + geom_boxplot() + ggtitle("Boxplot of City MPG v. Class") + xlab("Class") + ylab("City MPG")
```
...
p <- ggplot() + 
  geom_polygon(data = usa, aes(x = long, y = lat, group = group), fill = "steelblue", color = "black") + 
  coord_quickmap()
...
mpg %>% ggplot(mapping = aes(x = class)) +  geom_bar() + theme_economist()
...
p = mpg %>% ggplot(mapping = aes(x = hwy, y = cty)) + 
  geom_point(position = "jitter") + 
  ggtitle("City MPG v. Highway MPG") + 
  theme_excel()
